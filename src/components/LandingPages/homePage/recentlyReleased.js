...
export default function RecentlyReleased() {
    ...
    function handleAllData() {
        axios.get(`${endpoints.getByCategory}?category=Recentlyreleased`).then((response) => {
    ...
    function handleViewAll() {
        let detailsName = btoa("Recently Released");
            ...
            {dataList?.length > 4 ? (
                <div className='highlyRatedDiv'>
                    <div className="iq-main-header d-flex align-items-center justify-content-between">
                        <h4 className='main-title'>Recently Released</h4>
