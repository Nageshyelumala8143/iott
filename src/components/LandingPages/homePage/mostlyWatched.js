...
export default function MostlyWatched() {
    ...
    function handleAllData() {
        axios.get(`${endpoints.getByCategory}?category=MostlyWatched`).then((response) => {
    ...
    function handleViewAll() {
        let detailsName = btoa("Mostly Watched");
            ...
            {dataList?.length > 4 ? (
                <div className='highlyRatedDiv'>
                    <div className="iq-main-header d-flex align-items-center justify-content-between">
                        <h4 className='main-title'>Mostly Watched</h4>
