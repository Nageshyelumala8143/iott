...
export default function IottPicks() {
    ...
    function handleAllData() {
        axios.get(`${endpoints.getByCategory}?category=iottpicksforyou`).then((response) => {
    ...
    function handleViewAll() {
        let detailsName = btoa("I OTT Picks For You");
            ...
            {dataList?.length > 4 ? (
                <div className='highlyRatedDiv'>
                    <div className="iq-main-header d-flex align-items-center justify-content-between">
                        <h4 className='main-title'>I OTT Picks For You</h4>
                    ...
                    <Slider {...settings}>
                        {dataList.map((data, index) => (
                            ...
                            >
                                ...
                                <div className='onhoverone'>
                          <div className='onhover-textone'>
                              <p>{data?.Description} +Lorem ipsum is placeholder text commonly used in the graphic, print, and publishing i</p>
